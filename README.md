...
`-50°<a<50°`, this is better understandable in the image below.
...
changes is the value of the parameters, first the `marker_type` is  `MARKER_TOKEN_GOLDEN` and also the angle change: `-35°<a<35°`.
